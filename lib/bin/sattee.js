...
Sattee._loadEvents = function(div){
    ...
    div.addEventListener("mouseup", function(event){Sattee.mouseIsDragged = false;runEvent("mouseReleased")});
    div.addEventListener("mousedown", function(event){Sattee.mouseIsDragged = true;runEvent("mouseDown")});
