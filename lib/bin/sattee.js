...
Sattee.clear = function (layer,options) {
    if (layer == undefined || typeof layer != "number" || layer < 0 || layer > this.layers)
...
Sattee.switchScene = function (name, reset) {
    ...
    function runLoop() {
        function _frame() {
            ...
            // set interval happens to be faster then set timeout.. hmmmmmmm i wonder how is that going to fuck up things
...
Sattee._loadEvents = function(div){
    ...
    div.addEventListener("mouseup", function(){runEvent("mouseReleased")});
